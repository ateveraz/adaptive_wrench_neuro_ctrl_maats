...
uav1 = uav;
uav1.initial_position = [0.5 0.5 1]';
uav2 = uav;
uav2.initial_position = [-0.5 0.5 1]';

%% Payload description
% Parameters
payload = struct;
payload.mass = 0.225;
payload.inertia_matrix = diag( [ 2.1, 1.87, 3.97 ] ) * 0.01;
% About UAVs 
payload.number_uav = 1;
payload.Rattach = zeros(3,4);
% Initial conditions
